...
@section('title', 'Auditory Brain Response | Kamatage Hearing Aid')
...
<div class="container-fluid" style="padding:0 24px;">
  ...
  <div style="margin-top:8px; margin-bottom:18px;" class="d-flex justify-content-between flex-wrap align-items-center">
    <div>
      <h4 style="font-weight:bold; margin-bottom:4px;">Auditory Brain Response</h4>
      <div class="text-muted" style="font-size:.95rem;">Latencies and amplitudes per ear.</div>
    </div>
  ...
  <div class="row g-3">
      ...
      <div class="card shadow-sm" style="border:1px solid #e2e8f0; border-radius:10px;">
        <div class="card-body">
          ...
          <ul class="list-group patient-menu">
            ...
            <a href="{{ route('staff.patient.record.details.abr', ['id' => $id]) }}" class="list-group-item d-flex align-items-center active text-decoration-none">
    ...
    <!-- Right panel: ABR form -->
    <div class="col-lg-8">
      <div class="card shadow-sm" style="border:1px solid #e2e8f0; border-radius:10px;">
        <div class="card-body">
          <form id="abrForm" method="POST" action="{{ route('staff.patient.service.session.save', ['id' => $id, 'service' => 'abr']) }}" novalidate>
            @csrf
            ...
            <div class="row g-3 mb-3">
              <div class="col-md-6">
                <label for="abr_date_taken" class="form-label fw-semibold">Date Taken</label>
                <input type="date" id="abr_date_taken" name="date_taken" class="form-control">
              </div>
            </div>

            <div class="mb-3">
              <label class="form-label">Notes</label>
              <textarea id="abr_notes" name="abr_notes" class="form-control" rows="4" placeholder="Enter any additional observations or recommendations..."></textarea>
            </div>
