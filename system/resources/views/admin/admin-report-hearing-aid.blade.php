...
@section('title', 'Hearing Aid Report | Kamatage Hearing Aid')

@section('content')
<div class="container-fluid" style="padding: 0 24px;">
    <!-- Header Section -->
    <div style="margin-top: 8px; margin-bottom: 8px;">
        <h3 style="font-weight: bold;">Hearing Aid Report</h3>
        <p class="text-muted mb-0" style="margin-top: -4px;">Summary of all Hearing Aid Records.</p>
    </div>
        ...
        <div class="d-flex gap-2 align-items-center">
            ...
            <div class="d-flex gap-2 align-items-center">
                ...
                <div class="input-group" style="width: 200px;">
                    ...
                    <input type="text" id="nameSearch" class="form-control border-start-0" placeholder="Search patient..." style="border-left: none;">
                </div>
                ...
                <table class="table table-hover mb-0 report-table align-middle hearing-aid-report-table">
                    <thead>
                        <tr>
                            ...
                            <th>Patient Name</th>
                            <th>Hearing Aid Brand</th>
                            <th>Hearing Aid Model</th>
                            <th class="text-center">Ear Side</th>
                            <th class="text-center">Date Issued</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class="empty-state">
                            <td colspan="6" style="text-align:center; color:#888; font-style:italic; height: 60px;">No records found</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td data-label="Hearing Aid Brand">Phonak</td>
                            <td data-label="Hearing Aid Model">TMAXX600 Chargable</td>
                            <td data-label="Ear Side" class="text-center">Left</td>
                            <td data-label="Date Issued" class="text-center">Jan 15, 2024</td>
                        </tr>
                        -->
                    </tbody>
                </table>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function filterHearingAids() {
        ...
        originalRows.forEach(row => {
            const patientCell = row.querySelector('td:nth-child(2)'); // Patient Name column
            const brandCell = row.querySelector('td:nth-child(3)'); // Brand column
            const modelCell = row.querySelector('td:nth-child(4)'); // Model column
            const dateCell = row.querySelector('td:nth-child(6)'); // Date Issued column
            ...
            const modelName = modelCell ? modelCell.textContent.toLowerCase() : '';
            const issueDate = dateCell ? dateCell.textContent : '';
            
            let showRow = true;
            
            // Filter by patient name, brand, or model
            if (nameFilter && !patientName.includes(nameFilter) && 
                !brandName.includes(nameFilter) && !modelName.includes(nameFilter)) {
                showRow = false;
            }
            
            // Filter by date
            if (dateFilterValue && dateCell && !issueDate.includes(dateFilterValue)) {
                showRow = false;
            }
